...
export function deriveRemediationSecurityProof({
  ...
  return {
    version: 'remediation-security-proof-v2',
        ...
        : !hasControlEvidence || !hasReanalysisEvidence
          ...
          : !proofComplete
            ...
            : !measurableReduction
              ...
              : 'Security-effect claims are grounded in fresh control evidence, fresh reanalysis evidence, verification, complete exposure reanalysis, and explicit lineage.'
  };
}
