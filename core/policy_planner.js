...
function knownControl(controlId, frameworks) { return Object.values(ControlMatrix).some(mapping => frameworks.some(framework => Array.isArray(mapping?.[framework]) && mapping[framework].includes(controlId))); }
